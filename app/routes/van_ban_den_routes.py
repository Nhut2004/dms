...
from app.pdf_utils import dong_dau_van_ban_den
...
def upload_file_van_ban_den(
    ...
    for file in files:
        ...
        # 1. Lưu file vật lý gốc vào ổ cứng trước
        ...
        # === 2. TÍNH NĂNG ĐÓNG DẤU PDF TỰ ĐỘNG ===
        if ext == "pdf":
            dong_dau_van_ban_den(file_path, db_van_ban.so_den, db_van_ban.ngay_den)
        # =========================================

        # 3. Tính toán lại dung lượng file (Làm sau khi đóng dấu vì file có thể nặng hơn)
